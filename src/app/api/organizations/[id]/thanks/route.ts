...
/**
 * GET /api/organizations/{id}/thanks
 * Public Hall of Thanks across all programs run by an organization.
 * Proxies to GET {BACKEND_API_URL}/organizations/{organizationId}/thanks?page=...&size=...
