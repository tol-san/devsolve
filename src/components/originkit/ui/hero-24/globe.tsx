...
import { geoEquirectangular, geoPath, type GeoSphere } from "d3-geo";
    ...
    useEffect(() => {
        ...
        const loadWorldData = async () => {
            try {
                ...
                const landFeatures: FeatureCollection = await response.json();
                ...
                if (showOutline && outlineColor && outlineRgba.a > 0) {
                    ...
                    /* Left the counters in place — they are what surfaced the
                       rebuild loop — but the log itself does not belong in a
                       shipped page's console. */
                }
