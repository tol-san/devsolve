        ...
        <div className="relative mx-auto w-full max-w-7xl px-6 sm:px-12">
          ...
          >
            ...
            >
              ...
              <ChevronRight className="size-3.5 text-slate-300 dark:text-neutral-600" />
              <span aria-current="page" className="text-slate-900 dark:text-neutral-200">
                Solution
              </span>
            </nav>
            ...
            <div className="mt-6 flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
              ...
              <p className="max-w-sm text-sm leading-relaxed text-slate-500 dark:text-neutral-400">
                Lead with the change that works, then the reasoning behind it.
                An answer someone can follow beats one they have to decode.
              </p>
            </div>
          </motion.header>
              ...
              <Notice
                ...
                body={
                  status === 404
                    ...
                    : "This problem could not be loaded, so there is nothing to answer yet."
                }
                problemId={problemId}
              />
            ) : isOwnProblem ? (
              <Notice
                title="You cannot answer your own problem"
                body="Solutions come from other people. You can accept one once it is posted, which marks the problem resolved."
                problemId={problemId}
              />
            ) : (
